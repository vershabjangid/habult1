...
export function DashContactBanner() {
          ...
          <div className="text-[black]">
            <div className="w-[100%] my-2 text-[18px] font-[500] my-5">
              ...
              <input
                ...
                onChange={(e) =>
                  formik.setFieldValue("AdminContactHeading", e.target.value)
                }
              />
            </div>
            <div className="w-[100%] my-2 text-[18px] font-[500] my-5">
              ...
              <input
                ...
                className=" border-[1px] border-[black] w-[100%] my-2 p-1 rounded"
                onChange={(e) =>
                  formik.setFieldValue("AdminContactParagraph", e.target.value)
                }
              />
            </div>
            ...
            <div className="w-[100%] my-2 text-[18px] font-[500] my-5">
              ...
              <input
                ...
                className=" border-[1px] border-[black] w-[100%] my-2 p-1 rounded"
                onChange={(e) =>
                  formik.setFieldValue("AdminContactBanner", e.target.files[0])
                }
              />
            </div>

...
export function RegisterForm() {
    ...
    let insertdata = (value) => {
        axios.post('http://localhost:5000/add-register', value)
            .then((res) => {
            ...
            <section className='login_main w-[100%] p-[15px]  bg-[#FCFAFF] flex justify-center items-center'>
                <Formik
                    ...
                    initialValues={{
                        ...
                        Firm_name: getlocaldata.Firm_name,
                        Category: getlocaldata.Category,
                        Bio: getlocaldata.Bio,
                ...
                >
                    <Form className='login_inner w-[572px] p-[35px] bg-white rounded-[12px]'>

...
import getintouch from "../images/a-photo-of-a-rectangular-orange-sign-with-white-te-8Sgfm3S1SEiiBkPg_1njiA--Lwc6QryQgORPjy-IN3rjA__1_.d56c01282e2e83dbdeb5-removebg-preview.png";
        ...
        <section className="landing_section w-[90%] m-auto h-auto flex justify-center ">
          ...
          <section className=" w-[50%] text-start px-5 flex flex-col mt-2">
            ...
            <p className="text-[18px] my-3 flex items-center">
              <FaLocationPin className="text-[30px] me-2" />
              &nbsp;<p> 18/CHB Jodhpur , (Raj) , 342003 India</p>
            </p>

            <p className="text-[18px] my-3 flex items-center">
              <FaPhone className=" rotate-[90deg] text-[30px] me-2" />
              &nbsp;<p> +91 8005960160</p>
            </p>

            <p className="text-[18px] my-3 flex items-center">
              <FaMessage className="text-[30px] me-2"/>
              &nbsp;<p>info@hubalt.in</p>
            </p>
          </section>
        </section>
